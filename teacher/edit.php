        ...
        <div class="row sidemain">
            ...
            <div class="col-md-10">
                <h5 class="text-success pt-3">
                    ...
                    $str = "select * from teacher_reg where empid = '$ed' ";
                ...
                <form action="./edit_data.php" onsubmit="return vali()" enctype="multipart/form-data" method="post" class="form-group">
                    ...
                    <div class="row py-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="emp_name" value="<?php echo $row["empname"] ?>" class="form-control" name="emp_name">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="emp_phone" value="<?php echo $row["emp_phone"] ?>" maxlength="10" class="form-control" name="emp_phone">
                    ...
                    <div class="row py-4">
                        <div class="col-md-6">
                            ...
                            <input type="email" id="emp_email" value="<?php echo $row["emp_email"] ?>" class="form-control" name="emp_email">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="emp_address"   class="form-control"  id="emp_address" cols="30" rows="4"><?php echo $row["emp_address"] ?></textarea>
                            <!-- <input type="text" id="emp_address"  class="form-control" name="emp_address"> -->
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-md-6">
                            ...
                            ?>
                            <img src="../teacher_image/<?php echo $row["timg"] ?>" name="image" id="timgold" width="50%" alt="image" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label for="img">
                               Update Photo
