        ...
        <div class="row sidemain">
            <div class="col-md-2 side">
                <ul>
                    ...
                    <li>
                        <a href="./teacher_reg.php"><i class="fa-solid fa-user fa-xl" style="color: #000000"></i>Teacher Registration</a>
                        <ul id="tec">
                ...
                <div class="table-responsive py-1">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $str = "select e.empid,e.timg,e.empname,c.sub_name,e.emp_phone,e.emp_email,e.emp_address,e.emp_gender from teacher_reg as e , subject as c  where  c.subj_id = e.subj_id order by e.empid";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="../teacher_image/<?php echo $row["timg"]?>" height="50px" alt="image" ></td>
                                    <td><?php echo $row["emp_address"] ?></td>
                                    <!-- <td><?php echo $row["emp_pass"] ?></td> -->
                                    <td><?php echo $row["emp_gender"] ?></td>
                                    <td><?php echo $row["sub_name"] ?></td>
                                    <td>
                                        <a class="btn btn-success" href="./delete.php?del=<?php echo $row["empid"] ?>"onclick="return del()">Delete</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-success"  href="./edit.php?edit=<?php echo $row["empid"] ?>"  >Edit</a>
                                    </td>
                                </tr>
                        </tbody>
                    <?php
