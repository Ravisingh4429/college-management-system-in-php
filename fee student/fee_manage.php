        ...
        <div class="row sidemain">
            <div class="col-md-2 side">
                <ul>
                    ...
                    <li>
                        <a href="./fee_reg.php"><i class="fa-solid fa-credit-card fa-xl" style="color: #000000"></i>Student Fee</a>
                        <ul id="tec">
                ...
                <div class="table-responsive py-1">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $str = "select s.stu_id,s.fee_status,s.sname,s.stu_fathername,s.sphone,s.sgender,fs.tottal_fee,c.course_name from stu as s , fee_student as fs , course as c where s.course_id = fs.course_id and fs.course_id=c.course_id and s.fee_status='unpaid'  order by s.stu_id";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["tottal_fee"] ?></td>
                                    <td><?php echo $row["course_name"] ?></td>
                                    <td><?php echo $row["fee_status"] ?></td>

                                    <td>
                                        <a class="btn btn-success" href="./make_payment.php?edit=<?php echo $row["stu_id"] ?>">Make Payment</a>
                                    </td>
                                </tr>
                        </tbody>
