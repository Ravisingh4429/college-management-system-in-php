...
<html lang="en">
  ...
  <body>
      ...
      <div class="row sidemain">
        ...
        <h5 class="text-success pt-3">
              ...
              <?php
                ...
                $ren=time().'2024'.rand(1,100);
                
                ?>
            </h5>
            <form action="./salary_reg_data.php" onsubmit="return vali()" method="post" class="form-group">
                <div class="row py-4 ">
                    <div class="col-md-6">
                        <label for="salary_id">
                            Salary Id
                        </label>
                        <input type="text" id="salary_id" value=<?php echo $ren?> class="form-control" name="salary_id">
                ...
                <div class="row py-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" placeholder="Per Day" id="Salary"  class="form-control" name="Salary">
                        <p id="errsar" class="err"></p>
                    </div>
    ...
    <script>
        ...
        function vali() {
            if (salary_id.value == "") {
                document.getElementById("errid").innerHTML = "enter valid number";
                no = 0;
            }else {
            ...
            if (Salary.value == "") {
                document.getElementById("errsar").innerHTML = "enter valid number";
                no = 0;
            }  else {
                document.getElementById("errsar").innerHTML = "";
                no = 1;
            }
